...
@Component({
  selector: 'app-emp-details-pipe',
  templateUrl: './emp-details-pipe.component.html',
  styleUrls: ['./emp-details-pipe.component.css']
})
export class EmpDetailsPipeComponent implements OnInit {
